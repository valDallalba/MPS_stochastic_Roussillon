...
#SBATCH -J job_calibration_permea_mcmc.sh             # job name
#SBATCH -o job_calibration_permea_mcmc.out         # output file, redirection of stdout (and stderr (merged))
...
time srun python3 run_calibration_k_field_mcmc_full.py -cpu_nb ${SLURM_CPUS_PER_TASK}
